    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        <div class="flex-1 flex flex-col p-8 gap-8 overflow-auto">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="relative">
                        ...
                        <input v-model="searchQuery" type="search" placeholder="Search employees..." class="pl-9 pr-4 py-2.5 text-sm bg-white border border-gray-200 rounded-lg text-gray-700
                   ...
                   background-repeat: no-repeat; background-position: right 0.6rem center; background-size: 1rem;">
                    ...
                    <!-- Add Button -->
                    <button class="flex items-center gap-2 bg-lime-300 hover:bg-lime-400 active:scale-95 text-gray-900
            ...
            <div class="grid grid-cols-4 gap-5">
                <Employee v-for="stat in stats" :key="stat.lab" :number="stat.val" :text="stat.lab"
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="divide-y divide-gray-100">
                    <EmployeeStaff v-for="emp in filteredEmployees" :key="emp.name + emp.email" :picture="emp.picture"
                        :name="emp.name" :email="emp.email" :department="emp.department" :role="emp.role"
                        :salary="emp.salary" :status="emp.status" @edit="editEmployee(emp)"
                        @delete="deleteEmployee(emp)" />

                    <!-- Empty state -->
                    <div v-if="filteredEmployees.length === 0"
                        class="flex flex-col items-center justify-center py-16 text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 mb-3 opacity-40" fill="none"
